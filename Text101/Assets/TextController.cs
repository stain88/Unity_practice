...
//		print (myState);
	...
	void corridor_2 () {
		text.text = "Back to the corridor, having declined to dress up as a cleaner.\n\n" +
	...
	void lock_1 () {
		text.text = "You carefully put the mirror through the bars, and turn it around " +
								...
								"the buttons. You press the dirty buttons, and you hear a click.\n\n" +
	...
	void corridor_0 () {
		text.text = "You're out of your cell, but not out of trouble" +
								"You are in a corridor, there's a closet and some stairs leading to " +
